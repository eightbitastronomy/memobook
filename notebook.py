...
### the following class, CustomNotebook, is code that I copied from a stackoverflow thread...I was too lazy to do it myself... ###
...
### the following is a class that I copied from a stackoverflow thread...I was too lazy to do it myself... ###
### cannot recall if I made any minor changes to it ###
